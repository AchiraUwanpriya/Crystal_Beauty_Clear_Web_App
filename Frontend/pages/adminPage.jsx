    ...
    return(
        ...
        <div className="w-full h-full bg-primary flex p-2">
            ...
            <div className="flex flex-row w-[90%] h-[70px] bg-accent items-center rounded-2xl mb-[20px]">
                <img src="/logo.png" alt="CBC - Crystal Beauty Clear" className="h-[100px]"></img>
                <span className="text-white text-lg ml-5">Admin Panel</span>
            </div>
            <Link to="/admin" className="w-[90%] hover:bg-accent rounded-lg flex items-center gap-2 px-4 ">
                <FaChartLine/>
                Dashboard
            </Link>
            <Link to="/admin/orders" className="w-[90%] hover:bg-accent rounded-lg flex items-center gap-2 px-4 ">
                <MdOutlineShoppingCartCheckout className="text-xl"/>
                Orders
            </Link>
            <Link to="/admin/products" className="w-[90%] hover:bg-accent rounded-lg flex items-center gap-2 px-4 ">
                <BsBox2Heart />
                Products
            </Link>
            <Link to="/admin" className="w-[90%] hover:bg-accent rounded-lg flex items-center gap-2 px-4 ">
